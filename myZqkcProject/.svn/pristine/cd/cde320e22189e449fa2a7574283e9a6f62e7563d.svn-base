...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="#"><i class="icon icon-share-alt"></i> <span class="text">退出登录</span></a></li>
  </ul>
</div>
<div id="search">
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <li class="submenu active"> <a href="#"><i class="icon icon-th-list"></i> <span>项目案例</span> <span class="label label-important">3</span></a>
       ...
       <li><a href="<%=basePath%>project/addProjectTry">添加项目案例</a></li>      
         <li><a href="<%=basePath%>project/findProjectAll">信息展示列表</a></li>
      </ul>
    </li>
...
<div id="content-header">
  ...
  <div class="container-fluid">
        ...
        <div class="widget-title"> 
        	<span class="icon"><a href="<%=basePath%>project/userBack"><button type="submit" class="btn btn-mini btn-success">返回首页</button></a></span>
        
           <h5>修改展示模块表单</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="<%=basePath%>project/updateProject" method="get" class="form-horizontal">
           
            <div  class="control-group clearboth">
              <label class="control-label">项目工程名 :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="案例体验" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">简介</label>
              <div class="controls">
                <textarea class="span11" placeholder="请输入简介"></textarea>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="http://"/>
                </div>
            </div>
            <div class="control-group">
              <label class="control-label">权重</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="权重" />
              </div>
            </div>
