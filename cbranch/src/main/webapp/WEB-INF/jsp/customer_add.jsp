  ...
  <div id="content-header">
    ...
    <div id="breadcrumb">
    	<a href="<%=basePath%>user/index" class="tip-bottom" data-original-title="前往首页">
    		<i class="icon-home"></i> 首页</a> <a href="list" >业务客户</a> 
    		<a href="#" class="current">添加业务客户</a>
    </div>
     <!--树形指示栏 end-->
    ...
    <div class="row-fluid">
      <div class="span11">
          ...
          <div class="widget-title"> <span class="icon">
        		<a href="list">
        		<button type="submit" class="btn btn-mini btn-success">返回业务客户</button></a></span>
            <h5>添加业务客户</h5>
          </div>
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="add" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input  class="span6" type="text" name="name" id="name">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">客户地址：</label>
                <div class="controls">
                  <input  class="span6" type="text" name="url" id="url">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                	<input  class="span3" type="number" name="power" value="1" min="1" max="999" step="1"/>
                </div>                 
             </div>
             <div class="control-group">
                <label class="control-label">客户介绍：</label>
                <div class="controls">
                  <textarea class="span6" rows="2" name="description" id="description"></textarea>
                </div>
              </div>
