          ...
          <div class="widget-content nopadding">          	
            <table class="table table-bordered data-table table-list">
              ...
              <c:forEach var="project" items="${projectList}" varStatus="staturs">
                <tr>
                  <td id="td"><input type="checkbox" value="${project.id}" id="checkAll" name="subChk"/></td>
                  <td id="td"><c:out value="${project.id}"></c:out></td>
                  <td id="td"><c:out value="${project.name}"></c:out></td>
                  <td id="td"><c:out value="${project.title}"></c:out></td>
                  <td id="td"><c:out value="${project.type}"></c:out></td>
                  <td id="td"><c:out value="${project.url}"></c:out></td>
                  <td id="td"><c:out value="${project.path}"></c:out></td>
                  <td id="td"><c:out value="${project.remark}"></c:out></td>
                  <td id="td"><c:out value="${project.power}"></c:out></td>
                 <td><a class="btn btn-danger" id="btn-del" href="<%=basePath%>project/deleteProject?id=${project.id}">删除</a>&nbsp;&nbsp;<a id="btn-update" class="btn btn-success" href="<%=basePath%>project/updateProjectTry?id=${project.id}&name=${project.name}&title=${project.title}&url=${project.url}&type=${project.type}&path=${project.path}&remark=${project.remark}&power=${project.power}">修改</a></td>
                </tr>
                </c:forEach>                
              </tbody>
            </table>
...
<script>
 ...
 var href=$("#btn-update").attr("href");
 href = encodeURI(href); 
 $("#btn-update").attr("href",href);
 alert(href +"==="+$("#btn-update").attr("href"));
</script>
</body>
</html>