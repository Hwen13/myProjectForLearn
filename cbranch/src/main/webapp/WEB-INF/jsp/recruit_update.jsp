  ...
  <ul>
    ...
    <li class="submenu"> <a href="<%=basePath%>banner/toBanner"><i class="icon icon-inbox"></i> <span>轮播管理</span><span class="label label-important">2</span></a> 
      <ul>
        ...
        <li><a href="<%=basePath%>banner/toBanner">轮播列表</a></li>
      </ul>
    </li>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-title"> 
        	<span class="icon"><a  href="<%=basePath %>recruit/findAllRecruit">
        		<button type="submit" class="btn btn-mini btn-success">返回招聘列表</button></a></span>
          <h5>修改招聘信息</h5>         		     
        </div>
        <div class="widget-content nopadding">
          <form action="updateRecruit" method="get" class="form-horizontal">
            <div class="control-group clearboth">
              <label class="control-label">岗位名：</label>
              <div class="controls">
              <input type="hidden" name="id" value="${recruit.id}"/>
                <input type="text" class="span4" name="job" value="${recruit.job}" placeholder="例：php工程师" /> 
              </div>
            </div>
             <div class="control-group clearboth">
              <label class="control-label">招聘人数：</label>
              <div class="controls">
             <input type="text" class="span4" name="sum" value="${recruit.sum}" placeholder="该职位人数" />
              </div>
            </div>
            <div class="control-group clearboth">
              <label class="control-label">招聘标题：</label>
              <div class="controls">
                <input type="text" class="span4" name="title1" value="${recruit.title1}" placeholder="我们真诚招募WEB前端开发工程师，关于这一职位要求如下：" />
              </div>
            </div>
             <div class="control-group1">	
              <label class="control-label">招聘要求: 1.</label>
              <div class="controls">
                <input type="text" name="demand"  class="span4" value="${recruit.requirement}" placeholder="招聘要求"/>
              <!--   <a id="btn1-add" class="btn btn-primary">追加</a>&nbsp;&nbsp;<span></span><a id="btn1-del" class="btn btn-danger">删除</a> -->
             ...
             <!--  <label id="zch" class="control-label"></label>             
              ...
              <div class="controls">
                <input type="text" name="title2" class="span4" value="${recruit.title2}" placeholder="如：岗位职责" />
              </div>              
            </div>	        
             <div class="control-group">
              <label class="control-label">岗位职责: 1.</label>
              <div class="controls">
                <input type="text" name="neaten" class="span4" value="${recruit.qualification}" placeholder="1.整理代码" />
               <!--  <a id="btn2-add" 
                class="btn btn-primary">追加</a>&nbsp;&nbsp;<span></span><a id="btn2-del" class="btn btn-danger">删除</a> -->
                <a href="javascript:void(0);" id="add-qual" title="添加职责要求" >
                 <i class="icon-plus-sign" style="font-size: 20px;vertical-align: middle;color:#51a351"></i>
                </a>  
              </div>
     ...
     //添加招聘要求 
	   $("#add-req").click(function(){        
        $htm = "<div class='data-field'><label class='control-label'>"+no+". </label>"+
                "<div class='controls'>"+
                "<input type='text' name='requirement' class='span4' "+
                "placeholder='职责要求' />"+
    ...
    //添加职责要求
     $("#add-qual").click(function(){        
        $htmq = "<div class='data-qual'><label class='control-label'>"+qno+". </label>"+
                "<div class='controls'>"+
                "<input type='text' name='qualification' class='span4' "+
                "placeholder='招聘要求' />"+
