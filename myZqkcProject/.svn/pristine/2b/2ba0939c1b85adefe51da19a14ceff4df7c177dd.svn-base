...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
   <li class="submenu "><a href="index"><i class="icon icon-home"></i> <span>首页</span></a> </li>
  ...
  <div id="content-header">
    ...
    <div id="breadcrumb">
    	<a href="index.html" class="tip-bottom" data-original-title="前往首页">
    		<i class="icon-home"></i> 首页</a> <a href="toNavigation">导航栏列表</a> 
    ...
    <div class="row-fluid">
      <div class="span11"> 
          ...
          <div class="widget-title">            
        		...
        		<a href="<%=basePath%>navigation/addNavigation"><button class="btn  btn-success">添加导航</button>	</a>        		
          </div>
                		...
                		<c:forEach items="${navigation}" var="nav">
                			<tbody>
	                			 <td><input type="checkbox" /> </td>
				                  <td>${nav.name }</td>
				                  <td>${nav.title }</td>
				                  <td><a href="http://${nav.url}" target="_blank">${nav.url}</a></td>				                 
				                  <td class="center">${nav.power} </td>
				                  <td>
				                     <a href="<%=basePath%>navigation/doDeleteNavigation?id=${nav.id}" 
