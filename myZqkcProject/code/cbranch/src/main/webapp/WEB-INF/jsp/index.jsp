  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
          ...
          <li class="bg_lb"> <a href="navigation_list.html"> <i class="icon-dashboard"></i> 
          	<span class="label label-important">${navigations}</span> 导航管理 </a> </li>
          <li class="bg_lg span3"> <a href="carousel_list.html"> <i class="icon-signal"></i><span class="label label-important">${banners}</span> 轮播管理</a> </li>
          <li class="bg_ly"> <a href="<%=basePath%>business/list"> <i class="icon-inbox"></i>
          	<span class="label label-success">${business}</span> 平台展示 </a> </li>
          <li class="bg_lo"> <a href="projectSelect.html"> <i class="icon-th"></i><span class="label label-important">${projects}</span> 项目案例</a> </li>
         <!-- <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> 业务客户</a> </li>-->
  <!--        <li class="bg_lo span3"> <a href="form-common.html"> <i class="icon-th-list"></i> Forms</a> </li>-->
          <li class="bg_ls"> <a href="recruit_list.html"> <i class="icon-tint"></i><span class="label label-important">${recruits}</span> 招聘管理</a> </li>
          ...
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="site-stats">
                ...
                <li class="bg_lh" onclick="adduser(this)" data-url="<%=basePath%>${addUser}"><i class="icon-plus"></i> <strong>${sum}</strong> <small>新用户 </small></li>
