...
public class ResumeController {
	...
	public ModelAndView deleteResume(HttpSession session, int id)
			throws Exception {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView findByIdResume(HttpSession session, int id)
			throws Exception {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView findAllResume(HttpSession session, Resume resume)
			throws Exception {
		ModelAndView mv = new ModelAndView();
