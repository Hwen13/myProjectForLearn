            ...
            <table class="table table-bordered data-table table-list">          	
              ...
              <c:otherwise>
              	<c:forEach items="${list}" var="cus">
	                <tr>
	                  <td><input type="checkbox" name="chbox" value="${cus.id}"/></td>
	                  <td>${cus.title}</td>
	                  <td>${cus.name}</td>
	                  <td>${cus.url}</td>
	                  <td><a><img src="<%=basePath%>${filepath}"/></a></td>
	                  <td>${cus.power}</td>
	                  <td>${cus.description}</td>
	                  <td>
	                     <a href="delete?id=${cus.id}" class="btn btn-danger btn-remove">删除</a>&nbsp;&nbsp;
	                     <a class="btn btn-success" href="change?id=${cus.id}">修改</a>                  
	                  </td>
	                </tr>
                  </c:forEach>
                </c:otherwise>
