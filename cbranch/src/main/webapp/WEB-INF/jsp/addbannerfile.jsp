  ...
  <div id="content-header">
    ...
    <div id="breadcrumb">
    	<a href="index.html" class="tip-bottom" data-original-title="前往首页">
    		...
    		<a href="<%=basePath %>banner/toBanner" class="current">轮播图管理</a>
    </div>
     <!--树形指示栏 end-->
    ...
    <div class="row-fluid">
      <div class="span11">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" action="<%=basePath%>banner/doAddBannerfile" enctype="multipart/form-data" method="POST" >                      	         	              
