  ...
  <div class="container-fluid">
    ...
    <div class="widget-box">
      <div class="widget-title">        
       	 <h5>招聘信息表 </h5>           
    			<button  class="btn btn-danger" style="margin-top: 3px;">批量删除</button>	
        ...
        <table class="table table-bordered data-table table-list">
          ...
          <tbody>
             <c:forEach var="recruit" items="${list}" varStatus="statrus"> 
              ...
              <td>服务人民</td>
              <td>1</td>
             <td><a href="deleteRecruit" class="btn btn-danger" id="btn-del">删除</a>&nbsp;&nbsp;
                 <a href="<%=basePath %>recruit/recruitUpdate" class="btn btn-success">修改</a></td>             
