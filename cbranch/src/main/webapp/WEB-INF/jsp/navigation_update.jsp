  ...
  <div id="content-header">
    ...
    <div id="breadcrumb">
    	<a href="<%=basePath%>user/index" class="tip-bottom" data-original-title="前往首页">
    		...
    		<a href="#" class="current">修改导航栏信息</a>
    </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-title"> <span class="icon">
        		<a href="<%=basePath%>navigation/toNavigation">
        		<button type="button" class="btn btn-mini btn-success">返回导航管理</button></a></span>
          <h5>修改导航栏</h5>
        </div>       
        <div class="widget-content nopadding">
          <form action="<%=basePath%>navigation/doUpdateNavigation" method="get" class="form-horizontal">
            <div class="control-group clearboth">
              <label  class="control-label">导航名 :</label>
              <div class="controls">
              	<input type="hidden" value="${nav.id}" name="id"/>
                <input type="text" class="span4" name="name" placeholder="请输入合法标题名" value="${nav.name}" />
              </div>
            </div>
             <div class="control-group clearboth">
              <label  class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span4" name="title" placeholder="请输入合法标题名" value="${nav.title}" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">连接地址 :</label>
              <div class="controls">
              <input type="text" class="span4" name="url" placeholder="请输入正确的连接地址" value="${nav.url}" />
              </div>
            </div>
           <div class="control-group">
              <label class="control-label">权重:</label>
              <div class="controls">
                <input type="number" class="span4" name="power" value="${nav.power}" min="1" max="999" step="1" />
              </div>
            </div>                    
