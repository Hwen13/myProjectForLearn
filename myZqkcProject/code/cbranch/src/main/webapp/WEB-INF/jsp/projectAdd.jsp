...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>
    	<span class="text">欢迎登录</span><b class="caret"></b></a>
...
<div id="content">
 <div id="content-header">
    <div id="breadcrumb"> <a href="<%=basePath%>project/userBack" class="tip-bottom" data-original-title="前往首页">
        ...
        <div class="widget-title"> 
        	<span class="icon">
        		<a href="<%=basePath%>project/findProjetcAll">
        		<button type="submit" class="btn btn-mini btn-success">返回项目案例列表</button></a></span>
          <h5>添加项目案例</h5>              
        </div>
        <div class="widget-content nopadding">
          <form action="<%=basePath%>project/addProject" method="get" class="form-horizontal">           
            <div class="control-group clearboth">
              ...
              <div class="controls">
                <input type="text" class="span6" placeholder="创业之星服务平台" name="title"/>
                </div>
            </div> 
            <div class="control-group">
              <label class="control-label">链接</label>
              <div class="controls">
                <input type="url" class="span6" placeholder="http://" name="url"/>
                </div>
            </div>
             <div class="control-group clearboth">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input  class="span6"  type="file"  path="path" name="path"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">简介：</label>
              <div class="controls">
                <textarea class="span6" rows="4" placeholder="请输入简介" name="remark"></textarea>
              </div>
            </div> 
            <div class="control-group">
